...
folder_name=tcga_fn_i_lr_2e-02_b_lr_2e-03_i-b_dr_1e-03_i_OPT_SGDW_i_loss_cosines_bs_1000_rest_default_topk_p_0.008
data_name=TCGA
...
dropout_name='True'
dropout_rate=0.25
i_optimizer_name="SGDW"
b_optimizer_name="AdamW"
c_optimizer_name="AdamW"
i_loss_name="cosine_similarity"
