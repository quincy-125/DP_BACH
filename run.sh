...
folder_name=tcga_mc_ga_ilr_2e-03_idr_1e-04_iloss_focal_dr_0.5_bs_2000_rest_default_topk_p_0.004
data_name=TCGA
...
mkdir -p $result_path
result_file_name='clam_tcga_test.tsv'
...
i_loss_name="sigmoid_focal_crossentropy"
